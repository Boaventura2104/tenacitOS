...
const dockItems = [
  ...
  { href: "/org", label: "Organização", icon: Building },
  { href: "/kanban", label: "Kanban", icon: LayoutList },
  { href: "/memos", label: "Memos", icon: Mail },
  { href: "/goals", label: "Metas $50", icon: Target },
  ...
  { href: "/office", label: "Office 3D", icon: Building2 },
